...
Ciclo 1: ejecutar la **Fase 1 (Auditoría)** del manual — investigar qué cuentas de
monetización existen (AdSense, Stripe, Google Play) revisando los repos y señales
disponibles del dueño — y luego pasar a **Fase 2 (Idear)** y elegir la primera app.
...
_(ninguna todavía — el ciclo 1 probablemente agregue aquí la creación de la cuenta de
AdSense si la auditoría confirma que no existe)_
